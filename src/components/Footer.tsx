const Footer = () => (
  <footer className="bg-foreground text-primary-foreground/70 font-body text-sm py-10 px-5 md:px-8 pb-24 md:pb-10">
    <div className="container mx-auto max-w-4xl text-center space-y-2">
      <p className="text-primary-foreground font-heading text-lg font-semibold">Sae Sky Thaimassage</p>
      ...
      <p className="pt-4 text-primary-foreground/40">© {new Date().getFullYear()} Sae Sky Thaimassage. Alla rättigheter förbehållna.</p>
    </div>
  </footer>
);
